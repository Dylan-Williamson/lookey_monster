...
class LookeyMonster::CLI
  ...
  def start
    ...
    if input == "list"
      ...
      print logo 
      print "-------".cyan + "Enter track and artist below".light_red + "------\n\n\n".cyan
